...
(function(ext) {
  ...
  var words = {
    en: {
      ...
      playNote: 'play note',
      duration: 'duration',
      getTacoCount: 'measure taco count',
      resetTacoCount: 'reset taco count'
    },
    he: {
      brake: 'מיידי',
      coast: 'דעיכה',
      ...
      off: 'כבוי',
      blinking: 'הבהוב',
      startMotor: 'התחל מנוע',
      speed: 'מהירות',
      stopMotor: 'עצור מנוע',
      motor: 'מנוע',
      degreesAtSpeed: 'מעלות במהירות',
      setLEDColor: 'הפעל מנורת לד',
      status: 'סטאטוס',
      resetGyro: "אתחל ג'יירו",
      measureGyro: "מדוד ג'יירו",
      touchIsPressed: 'בדוק סנסור תחושה',
      measureColor: 'מדוד צבע',
      measureUltrasonic: 'מדוד אולטרה סוניק',
      playNote: 'נגן תו',
      duration: 'במשך',
      getTacoCount: 'מדוד ספירת טאקו',
      resetTacoCount: 'אתחל ספירת טאקו',
    },
  }
